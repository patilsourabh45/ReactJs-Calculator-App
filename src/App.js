...
const App = () => {
    ...
    return (
        <>
            <h1 style={{ textAlign: 'center',marginTop:'30px'}}>ReactJs Calculator</h1>
            <div className="container">
                ...
                <div className="keypad">
                    <button className="highlight test" onClick={clear} id="clear">Clear</button>
                    <button className="highlight test" onClick={backspace} id="backspace">C</button>
                    <button className="highlight test" name="/" onClick={handleClick}>&divide;</button>
                    ...
                    <button className="highlight test" name="*" onClick={handleClick}>&times;</button>
                    ...
                    <button className="highlight test" name="-" onClick={handleClick}>&ndash;</button>
                    ...
                    <button className="highlight test" name="+" onClick={handleClick}>+</button>
                    <button className="button"  name="0" onClick={handleClick}>0</button>
                    <button className="button"name="." onClick={handleClick}>.</button>
                    <button className="highlight test" onClick={calculate} id="result">=</button>
                </div>
            </div>
        </>
    );
